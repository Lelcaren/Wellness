...
const TransformMeals = ({ className = "" }) => {
  return (
    <section
      className={`w-full bg-gradient-to-br from-gray-50 via-green-50 to-blue-50 overflow-hidden flex flex-col items-start justify-start py-28 px-20 box-border text-left text-21xl text-color-scheme-1-text font-heading-desktop-h6 relative animate-fade-in
        lg:py-24 lg:px-12
        md:pt-20 md:pb-20 md:px-16 md:box-border md:text-13xl md:leading-[38px]
    ...
    >
      ...
      <div className="w-full max-w-none xl:max-w-7xl mx-auto flex flex-row items-center justify-between gap-20 relative z-10 lg:gap-16 md:gap-12 sm:flex-col sm:items-center sm:gap-8">
        ...
        {/* Enhanced Text Content Section with glassmorphism */}
        <div className="w-full xl:flex-1 flex flex-col items-start justify-start py-5 px-0 box-border gap-8 xl:min-w-[400px] lg:min-w-[350px] sm:min-w-full sm:items-center xl:max-w-[50%] animate-slide-up">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-6 sm:items-center lg:items-start">
            ...
            <p className="self-stretch relative text-lg leading-[160%] text-gray-600 font-light lg:text-xl sm:text-base sm:text-center lg:leading-[32px]">
          ...
          {/* Enhanced List Items Section with glassmorphism cards */}
          <div className="self-stretch flex flex-col items-start justify-start sm:items-center gap-6">
            <div className="self-stretch flex flex-row items-start justify-between gap-8 lg:gap-6 md:gap-5 sm:flex-col sm:items-center sm:gap-4">
              ...
              {/* Enhanced ListItem with glassmorphism background */}
              <div className="flex-1 bg-white bg-opacity-60 backdrop-blur-sm p-6 rounded-2xl border border-white border-opacity-50 shadow-lg hover:bg-opacity-80 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1">
                <ListItem
          ...
          <div className="flex flex-row items-center gap-8 mt-4 flex-wrap sm:justify-center sm:gap-6">
            ...
            <div className="flex flex-row items-center gap-2 bg-white bg-opacity-60 backdrop-blur-sm px-4 py-2 rounded-full border border-blue-200 shadow-lg hover:bg-opacity-80 transition-all duration-300 transform hover:scale-105">
              ...
              <span className="text-sm font-medium text-gray-700">Nutrition Focused</span>
            </div>
          </div>
      ...
      <div className="w-full max-w-none xl:max-w-7xl mx-auto flex flex-row items-center justify-center gap-12 mt-16 text-gray-600 relative z-10 animate-slide-up delay-200 lg:gap-8 lg:mt-12 md:gap-6 md:mt-10 sm:flex-col sm:gap-4 sm:mt-8">
        ...
        <div className="flex flex-col items-center gap-2 bg-white bg-opacity-50 backdrop-blur-sm px-6 py-4 rounded-xl border border-white border-opacity-40 shadow-lg hover:bg-opacity-70 transition-all duration-300 transform hover:scale-105">
          ...
          <div className="text-sm font-medium tracking-wide">Meal Plans</div>
        </div>

        <div className="flex flex-col items-center gap-2 bg-white bg-opacity-50 backdrop-blur-sm px-6 py-4 rounded-xl border border-white border-opacity-40 shadow-lg hover:bg-opacity-70 transition-all duration-300 transform hover:scale-105">
          <div className="text-2xl font-bold text-blue-600">Balanced</div>
          <div className="text-sm font-medium tracking-wide">Nutrition</div>
        </div>

        <div className="flex flex-col items-center gap-2 bg-white bg-opacity-50 backdrop-blur-sm px-6 py-4 rounded-xl border border-white border-opacity-40 shadow-lg hover:bg-opacity-70 transition-all duration-300 transform hover:scale-105">
          <div className="text-2xl font-bold text-green-600">Smart</div>
          <div className="text-sm font-medium tracking-wide">Shopping Lists</div>
        </div>
      </div>
    </section>
  );
