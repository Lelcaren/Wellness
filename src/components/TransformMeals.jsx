...
const TransformMeals = ({ className = "" }) => {
  return (
    <section
      className={`w-full bg-whitesmoke-100 overflow-hidden flex flex-col items-start justify-start py-28 px-20 box-border text-left text-21xl text-color-scheme-1-text font-heading-desktop-h6 lg:py-24 lg:px-24 md:py-20 md:px-16 sm:py-16 sm:px-8 ${className}`}
    >
      <div className="w-full max-w-none xl:max-w-7xl mx-auto flex flex-row items-center justify-between gap-20 lg:gap-16 md:gap-12 sm:flex-col sm:items-center sm:gap-8">
        {/* Text Content Section */}
        <div className="w-full xl:flex-1 flex flex-col items-start justify-start py-5 px-0 box-border gap-8 xl:min-w-[400px] lg:min-w-[350px] sm:min-w-full sm:items-center xl:max-w-[50%]">
        ...
        {/* Image Section */}
        <img
          className="h-[640px] lg:h-[500px] md:h-[400px] sm:h-[300px] w-full xl:flex-1 xl:max-w-[50%] relative overflow-hidden object-cover lg:min-w-[450px] sm:min-w-full"
