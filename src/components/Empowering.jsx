...
const Empowering = ({ className = "" }) => {
  return (
    <section
      className={`w-full bg-whitesmoke-200 overflow-hidden flex flex-col items-center justify-start py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 box-border gap-8 sm:gap-12 md:gap-16 lg:gap-20 text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-21xl text-color-scheme-1-text font-heading-desktop-h6 ${className}`}
    >
      <div className="w-full max-w-[1440px] mx-auto flex flex-col items-center gap-8 sm:gap-12 md:gap-16 lg:gap-20">
        {/* Section Heading */}
        ...
        {/* Features Container */}
        <div className="w-full bg-mediumaquamarine flex flex-col items-start justify-start text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
          <div className="self-stretch flex flex-row items-start justify-center flex-wrap content-start gap-6 sm:gap-8 md:gap-10 lg:gap-12">
            {[
              ...
              <div
                key={index}
                className="flex-1 flex flex-col items-center justify-start gap-4 sm:gap-6 md:gap-8 min-w-[280px] max-w-full sm:max-w-[calc(50%-16px)] lg:max-w-[calc(33.333%-16px)] xl:max-w-[400px] 2xl:max-w-[420px] p-4 sm:p-6"
              >
                {/* Feature Icon & Text */}
