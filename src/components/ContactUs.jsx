...
const ContactUs = ({ className = "" }) => {
  return (
    <section
      className={`w-full bg-whitesmoke-200 overflow-hidden flex flex-col items-start justify-start 
    ...
    >
      <div className="w-full max-w-[1440px] mx-auto flex flex-col gap-20 lg:gap-16 md:gap-12 sm:gap-10 xs:gap-6">
        {/* Heading Section */}
