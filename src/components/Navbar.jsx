...
const Navbar = ({ className = "", companyLogo, navLinksMargin }) => {
  ...
  // Custom button component to enhance the Join and Learn buttons
  const EnhancedButton = ({ style, button, className = "" }) => {
    ...
    const buttonStyles = {
      ...
      Secondary: "bg-white border border-blue-500 text-blue-500 hover:bg-blue-50 hover:shadow-sm"
    };
    ...
    >
      ...
      <div className="flex flex-row items-center justify-center gap-4 lg:hidden">
        <nav
          ...
          style={navLinksStyle}
        >
          <Link to="/home" className="flex flex-row items-center justify-center hover:text-blue-600 transition-colors duration-200 no-underline">
        ...
        <div className="flex flex-row items-center justify-center gap-3">
          {/* Using custom button components instead of Button component */}
        ...
        >
          <nav className="flex flex-col items-center justify-center gap-4 py-4 text-center text-base text-color-scheme-1-text font-heading-desktop-h6">
            ...
            <div className="flex flex-col items-center justify-center gap-3 mt-4 w-4/5">
              {/* Using custom button components in mobile menu */}
