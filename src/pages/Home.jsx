...
const Home = () => {
  return (
    <div className="relative w-full overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal]">
      ...
      <section
  className={`w-full max-w-[1440px] h-[900px] mx-auto overflow-hidden shrink-0 flex flex-row items-center justify-start 
...
>
  ...
  >
    ...
    >
      ...
      <p
        className={`self-stretch relative text-lg leading-[150%] 
          ...
          xs:text-xs`}
      >
        At [Your Organization’s Name], we empower you to achieve optimal health
        through personalized coaching and nutrition. Discover how our holistic
    ...
    >
      ...
      />
  <section className="max-w-[1440px] mx-auto bg-whitesmoke-200 overflow-hidden flex flex-col items-center justify-start py-28 px-16 box-border gap-20 text-center text-base text-color-scheme-1-text font-heading-desktop-h6 lg:py-16 lg:px-8 lg:gap-12 sm:py-10 sm:px-4 sm:gap-8">
  {/* Header Section */}
  ...
  <div className="self-stretch flex flex-col items-start justify-start">
    <div className="w-full flex flex-row items-start justify-center gap-12 lg:gap-6 lg:flex-wrap sm:gap-8 sm:flex-col">
      {/* Card 1 */}
      <div className="flex-1 overflow-hidden flex flex-col items-start justify-start gap-8 lg:min-w-[280px] sm:min-w-full sm:gap-4">
        <img
  ...
  <div className="flex flex-row items-center justify-start gap-6 text-left sm:flex-col sm:w-full sm:items-stretch">
    <button className="cursor-pointer border-color-scheme-1-text border-solid border-[1px] py-3 px-6 bg-[transparent] rounded-3xs overflow-hidden flex flex-row items-center justify-center sm:w-full">
      <div className="relative text-base leading-[150%] font-heading-desktop-h6 text-color-scheme-1-text text-left">
        Learn More
      </div>
    </button>
    <div className="overflow-hidden flex flex-row items-center justify-center gap-2 sm:w-full sm:justify-center">
